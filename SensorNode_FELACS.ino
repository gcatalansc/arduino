...
#define MAX_SAMPLES_COMPRESSED_AMOUNT1  64
#define MAX_SAMPLES_COMPRESSED_AMOUNT2  12
#define CAPTURE_TIME_SAMPLES            MAX_SAMPLES_COMPRESSED_AMOUNT1 * 10
#define COM_AND_TRANS_TIME_SAMPLES      10
...
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
//compresor de datos FELACS.
compressor_felacs  felacs;
...
void setup() 
{
  ...
  felacs.initialization(14, MAX_SAMPLES_COMPRESSED_AMOUNT2, MAX_PAYLOAD_SIZE);
  ...
  if (Serial.available() > 0)
  {
    ...
    {     
      ...
      if(samples_counter1 == samples_compressed_amount1)
      {
        ...
        felacs.compressorFELACS(data_set1[0], samples_compressed_amount1, bits_resolution_data1[0], stream_com_data, stream_index_available, stream_available_bits); 
        felacs.compressorFELACS(data_set1[1], samples_compressed_amount1, bits_resolution_data1[1], stream_com_data, stream_index_available, stream_available_bits); 
        felacs.compressorFELACS(data_set1[2], samples_compressed_amount1, bits_resolution_data1[2], stream_com_data, stream_index_available, stream_available_bits); 
        felacs.compressorFELACS(data_set1[3], samples_compressed_amount1, bits_resolution_data1[3], stream_com_data, stream_index_available, stream_available_bits); 
        felacs.compressorFELACS(data_set1[4], samples_compressed_amount1, bits_resolution_data1[4], stream_com_data, stream_index_available, stream_available_bits); 
        felacs.compressorFELACS(data_set1[5], samples_compressed_amount1, bits_resolution_data1[5], stream_com_data, stream_index_available, stream_available_bits); 
        felacs.compressorFELACS(data_set1[6], samples_compressed_amount1, bits_resolution_data1[6], stream_com_data, stream_index_available, stream_available_bits);    
        felacs.compressorFELACS(data_set1[7], samples_compressed_amount1, bits_resolution_data1[7], stream_com_data, stream_index_available, stream_available_bits);     

        //última compresión y obtención de la cantidad de bytes resultantes.
        compress_size                                 = felacs.compressorFELACS(data_set1[8], samples_compressed_amount1, bits_resolution_data1[8], stream_com_data, stream_index_available, stream_available_bits);
