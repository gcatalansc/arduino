...
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
//compresor de datos S-LZW MC.
compressor_slzw_mc  slzw_mc;
...
{  
  ...
  if (Serial.available() > 0)
  {
    ...
    {     
      ...
      //si hya más de una muestras por sensor, entonces.
      if(samples_counter1 > 0)
      {
        //bucle para obtener "di".
        for (int i1 = 0; i1 < 9; ++i1)
        {
          //obtención de "di".
          data_set1[i1][samples_counter1] = data_set1[i1][samples_counter1] - data_set1[i1][samples_counter1 - 1]; 
        }
      }      
      ...
      if(samples_counter1 == samples_compressed_amount1)
      {
        ...
        //reset dell tamaño de conpresión resultante.
        compress_size = 0;
        ...
        compress_size  = slzw_mc.compressorSLZW_MC(data_set1[0], samples_compressed_amount1, stream_com_data);     
        compress_size += slzw_mc.compressorSLZW_MC(data_set1[1], samples_compressed_amount1, stream_com_data);
        compress_size += slzw_mc.compressorSLZW_MC(data_set1[2], samples_compressed_amount1, stream_com_data);
        compress_size += slzw_mc.compressorSLZW_MC(data_set1[3], samples_compressed_amount1, stream_com_data);
        compress_size += slzw_mc.compressorSLZW_MC(data_set1[4], samples_compressed_amount1, stream_com_data);
        compress_size += slzw_mc.compressorSLZW_MC(data_set1[5], samples_compressed_amount1, stream_com_data);
        compress_size += slzw_mc.compressorSLZW_MC(data_set1[6], samples_compressed_amount1, stream_com_data);
        compress_size += slzw_mc.compressorSLZW_MC(data_set1[7], samples_compressed_amount1, stream_com_data);
        compress_size += slzw_mc.compressorSLZW_MC(data_set1[8], samples_compressed_amount1, stream_com_data);
